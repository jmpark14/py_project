...
print(len(name_list), len(title_list), len(test_list), len(score_list), len(period_list_1), len(period_list_2), len(local_list))

df = pd.DataFrame({'test_list':test_list, 'title_list':title_list, 'name_list':name_list, 'score_list':score_list, 'period_list_1':period_list_1, 'period_list_2':period_list_2, 'local_list':local_list})
df.to_csv("HRD-NET_ex2.csv", encoding='utf-8-sig', index=False)
